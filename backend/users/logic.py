...
def get_cart(cart_id):
    ...
    cart = Cart.objects.select_related('unregistered_user', 'unregistered_user__hash_code').prefetch_related(
...
def get_featured(featured_id):
    ...
    featured = FeaturedProducts.objects.select_related('unregistered_user', 'unregistered_user__hash_code').prefetch_related(
