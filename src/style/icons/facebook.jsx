    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
      <g clipPath="url(#clip0_8_415)">
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M9.07959 13.5H15.0796" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </g>
      <defs>
        <clipPath id="clip0_8_415">
          <rect width="24" height="24" fill="white" transform="translate(0.0795898)" />
        </clipPath>
      </defs>
    </svg>
  );
